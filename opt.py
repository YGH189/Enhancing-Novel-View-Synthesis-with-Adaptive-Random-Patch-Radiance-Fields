...
def config_parser(cmd=None):
    ...
    # rpsl
    parser.add_argument("--rpsl_weight", type=float, default=0.0)
    parser.add_argument("--rpsl_kernel", type=int, default=4)
    parser.add_argument("--rpsl_stride", type=int, default=4)
    parser.add_argument("--rpsl_repeat_time", type=int, default=10)
    parser.add_argument("--rpsl_patch_height", type=int, default=64)
    parser.add_argument("--rpsl_patch_width", type=int, default=64)
